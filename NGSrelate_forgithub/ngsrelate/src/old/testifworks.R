...
t<-runHmmld(data,pair=c(1,2),pos=pos/1e6,chr=rep(1:10,each=snp),back=0,ld_adj=F,epsilon=0.01)


source("ngsrelateHMM.R")
t2<-relateHMM(data-1,pair=c(1,2),pos=pos/1e6,chr=rep(1:10,each=snp),alim=c(0.001,0.15),epsilon=0.01,opti=2)
t2<-relateHMM(data-1,pair=c(1,2),pos=pos/1e6,chr=rep(1:10,each=snp),alim=c(0.001,0.15),epsilon=0.01,opti=2,par=c(calculate.a(0.75,0.25,0),0,0.25))
